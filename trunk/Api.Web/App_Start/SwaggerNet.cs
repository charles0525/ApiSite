...
namespace Api.Web.App_Start
{
    public static class SwaggerNet
    {
        ...
        public static void PostStart()
        {
            ...
            {
                throw new Exception("Please enable \"XML documentation file\" in project properties with default (bin\\Swagger.XML) value or edit value in App_Start\\SwaggerNet.cs");
            }
        }
    }
}